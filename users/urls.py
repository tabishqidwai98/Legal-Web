...
from .views import Cases_Fought_view, dashboard, detail_of_lawyer, register,index, User_Profile, lawyer_Profile_views, query_Lawyer_Profile, UserProfileListView, query_User_Profile, detail_of_User, CasesFoughtListView, query_Cases_Fought, detail_of_Cases_Fought, lawyerProfileListView
...
urlpatterns = [
    ...
    path('add_User/',User_Profile,name='add_Users'),
